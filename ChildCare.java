...
public class ChildCare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Women & Child Welfare Dept. Ludhiana");

        //web View
        mWebView = (WebView) findViewById(R.id.my_web_View);
        WebSettings webSetting = mWebView.getSettings();
        webSetting.setJavaScriptEnabled(true);
        mWebView.loadUrl("http://www.pbsocialsecurity.gov.in/html/contactus.html");
    ...
    private class MyWebviewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (Uri.parse(url).getHost().equals("http://www.pbsocialsecurity.gov.in/html/contactus.html")) {
                return false;
            }
